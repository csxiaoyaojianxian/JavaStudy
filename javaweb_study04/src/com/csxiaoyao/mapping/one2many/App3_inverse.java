...
public class App3_inverse {
	...
	public void save() {
		...
		/**
		 * 关系 inverse=true,  不会设置关联，此时的关联应该通过员工方维护
		 * 即dept_id字段为null，不会主动维护
		 */
	...
	//4. 是否设置inverse属性，在删除数据中对关联关系的影响
	// inverse=false, 有控制权， 可以删除。先清空外键引用，再删除数据（部门表的记录）。
